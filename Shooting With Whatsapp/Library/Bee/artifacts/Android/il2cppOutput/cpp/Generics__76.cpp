...
IL_002b:
	...
	}
	{
		...
		NullCheck(L_8);
		bool L_10;
		L_10 = Func_2_Invoke_m27C14ED46D9455A0F1AFFAE57C9349D5DD806976_inline(L_8, L_9, il2cpp_rgctx_method(method->klass->rgctx_data, 12));
		if (!L_10)
		{
			goto IL_0061;
		}
...
IL_004d:
	{
		...
		NullCheck(L_11);
		OVRAnchor_tC6603E0C1628ACAA50D8CCDCC267BFD246F5A061 L_13;
		L_13 = Func_2_Invoke_mDEDE7B8EE595559593A72200C3A67580A5AFFE7B_inline(L_11, L_12, il2cpp_rgctx_method(method->klass->rgctx_data, 13));
		((Iterator_1_tF3A0A5294A1320126A6954330013291058230FB2*)__this)->___current = L_13;
		return (bool)1;
	}
...
IL_0061:
	{
		...
		bool L_15;
		L_15 = Enumerator_MoveNext_mDD8EC577565E9EAF77DE7FEC5D006A1B4A070B8D(L_14, il2cpp_rgctx_method(method->klass->rgctx_data, 15));
		if (L_15)
		{
			goto IL_002b;
		}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* WhereSelectListIterator_2_Where_m383C936200ED799D26966D5A9C4AB9F120853C61_gshared (WhereSelectListIterator_2_t05D351D8CFE982C461A3B080F6437033D96E98D1* __this, Func_2_tD6E51019252E7D75CDCFF72CBA16F63B6A1C2D43* ___0_predicate, const RuntimeMethod* method) 
{
	{
		Func_2_tD6E51019252E7D75CDCFF72CBA16F63B6A1C2D43* L_0 = ___0_predicate;
		WhereEnumerableIterator_1_t50F95B98CA35A8BE86649ABFE4E4717E2D4E9E3F* L_1 = (WhereEnumerableIterator_1_t50F95B98CA35A8BE86649ABFE4E4717E2D4E9E3F*)il2cpp_codegen_object_new(il2cpp_rgctx_data(method->klass->rgctx_data, 18));
		WhereEnumerableIterator_1__ctor_m2BADAC051ACC4D2F0E344C0A0188378D4A34F227(L_1, (RuntimeObject*)__this, L_0, il2cpp_rgctx_method(method->klass->rgctx_data, 19));
		return (RuntimeObject*)L_1;
	}
}
#ifdef __clang__
...
IL_004d:
	{
		...
		NullCheck(L_11);
		RuntimeObject* L_13;
		L_13 = Func_2_Invoke_m0E63E4710CABB1BBE5380B06B8FE2540A9D0DA8F_inline(L_11, L_12, il2cpp_rgctx_method(method->klass->rgctx_data, 13));
		((Iterator_1_t99A1802EE86A3D5BF71B2DDB37F159C4AFA448EA*)__this)->___current = L_13;
		Il2CppCodeGenWriteBarrier((void**)(&((Iterator_1_t99A1802EE86A3D5BF71B2DDB37F159C4AFA448EA*)__this)->___current), (void*)L_13);
		return (bool)1;
	}
